...
EXAMPLES = {
        ...
        'POINT (Geojson)' : '{"type": "Point", "coordinates": [30.0, 10.0]}',
        'LINESTRING (Geojson)' : '{"type": "LineString", "coordinates": [[30.0, 10.0], [10.0, 30.0], [40.0, 40.0]]}',
        'POLYGON (Geojson)' : '{"type": "Polygon", "coordinates": [[[30.0, 10.0], [40.0, 40.0], [20.0, 40.0], [10.0, 20.0], [30.0, 10.0]]]}'
    }
